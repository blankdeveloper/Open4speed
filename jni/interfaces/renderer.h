...
public:
     ...
     */
    virtual void renderModel(model* m, glm::vec3 center) = 0;
     ...
     * @param center is model translation
     */
    virtual void renderShadow(model* m, glm::vec3 center) = 0;
     ...
     * @param center is model translation
     */
    virtual void renderSubModel(model* mod, model3d *m, glm::vec3 center) = 0;
