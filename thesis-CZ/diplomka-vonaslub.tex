...
Mapy osvětlení jsou textury 3D modelů, které obsahují informace o difuzním osvětlení. Difuzní osvětlení je závislé pouze na poloze světla, směru světla a povrchu tělesa, lze jej tedy pro statickou část modelu předpočítat.
...
\subsubsection{Imperfektní stínové mapy pro efektivní výpočet nepřímého osvětlení}
