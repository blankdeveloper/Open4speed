...
Pohled $P$ je MVP matice, pro získání pohledu $P'$ potřebujeme vypočítat reflexní matici $R$, která převrátí pohled podle normály povrchu $\vec{N}$.
              
\begin{center}
$d = -(\vec{N}_x + \vec{N}_y + \vec{N}_z)$
\end{center}
\begin{center}
$R = \begin{pmatrix}
