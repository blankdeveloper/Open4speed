...
\caption{Pomocný obrázek k výpočtu viditelnosti pomocí stínových map}
\end{figure}
\end{center}
...
\begin{center}
$d = SM[\vec{p}.x, \vec{p}.y]$
\end{center}

Nakonec zjistíme, jak se tyto hodnoty liší pomocí podmínky $|\vec{p}.z - d| < \epsilon$, kde $\epsilon$ je malé číslo filtrující numerickou chybu. Pokud je podmínka splněna, je bod osvětlený daným zdrojem světla.
\bigskip
