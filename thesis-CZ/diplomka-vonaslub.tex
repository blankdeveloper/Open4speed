...
Samotnou realizaci projektu lze rozdělit do dvou dílčích částí. První částí je předzpracování, ve kterém se vytváří mapy osvětlení. To znamená vytvoření koordinát map a vykreslení hodnot do map osvětlení. Druhou částí je samotný simulátor, který s těmito předzpracovanými hodnotami pracuje.

\section{Požadavky na funkčnost}

\section{Cílová platforma Android}
TODO:vysvělit problematiku lightmap

\section{Implementované grafické techniky}

\subsection{Mapy osvětlení}

\subsection{Dynamické aktualizování map osvětlení}
