...
\cite{Fast03} \cite{Interact12}
\cite{OpenGL10} \cite{Hawkins01} \cite{Buss03} \cite{Ericson04} \cite{Modern04}
\newpage
...
\caption{Ukázka vykreslené scény pomocí fotonového mapování}
\end{figure}
\end{center}
