...
\begin{center}
\begin{figure}[h]
\includegraphics[width=100mm]{figures/lmcoords.png}
\caption{Ukázka rozložení mapy osvětlení se spárovanými trojúhelníky}
\end{figure}
\end{center}
\newpage
...
\caption{Změna délky přepony trojúhelníka pro vytvoření páru dvou trojúhelníků}
\end{figure}
\end{center}
...
\begin{center}
\begin{figure}[h]
\includegraphics[width=100mm]{figures/cubemap.png}
\caption{Využití cube mapy jako stínové mapy pro bodové osvětlení}
\end{figure}
\end{center}
