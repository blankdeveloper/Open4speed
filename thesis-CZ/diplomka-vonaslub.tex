...
\begin{center}
\begin{figure}[h]
\includegraphics[width=100mm]{figures/shadowmaps.png}
...
\caption{Ukázka stínové mapy}
\end{figure}
\end{center}

\begin{center}
\begin{figure}[h]
\includegraphics[width=120mm]{figures/pcf.png}
\caption{Vyhodnocení úrovně zastínění pomocí PCF}
\end{figure}
\end{center}
\newpage
...
\begin{center}
\begin{figure}[h]
\includegraphics[width=120mm]{figures/pcf-example.png}
\caption{Ukázka filtrování PCF}
\end{figure}
\end{center}
